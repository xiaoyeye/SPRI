...
df = pd.read_table('raw_data/BC23209_C1_stdata.tsv', index_col=0)
...
ms_results.to_csv('output/BC2020_ms_spe.csv')
results.to_csv('output/BC2020_spe.csv')
