...
# MOB11
# read_path = "raw_data/Rep11_MOB_count_matrix-1.tsv"
# save_path = "output/MOB11_MERINGUE.csv"
# MOB12
read_path = "raw_data/Rep12_MOB_count_matrix-1.tsv"
save_path = "output/MOB12_MERINGUE.csv"
